...
void next_generation(int world[][MAX_X],
                     int prev_world[][MAX_X]);  // creating a new generation
void copy_world(int src[][MAX_X],
                int dst[][MAX_X]);  // copy the world from src to dst
int compare_world(
    int world_1[][MAX_X],
    int world_2[][MAX_X]);  // comparasion the current and previous worlds
int number_of_live(int world[][MAX_X]);  // get the number of all live cells in
                                         // the current world
int number_of_live_nb(int world[][MAX_X], int y,
                      int x);  // get the number of live neigbours
